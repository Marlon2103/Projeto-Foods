<!-- Branded consolidated documentation with clickable TOC and fixed header/footer -->
<style>
  body { font-family: Arial, Helvetica, sans-serif; }
  h1, h2, h3 { color: #ffcc00; }
  a.toc-link { color: #000; text-decoration: none; }
  /* Print margins and header/footer */
  @page { margin: 140px 40px 80px 40px; }
  header { position: fixed; top: 0; left: 0; right: 0; height: 120px; background: #000; color: #ffcc00; display:flex; align-items:center; padding: 12px 24px; }
  header img { height: 96px; }
  header .title { margin-left: 20px; font-size: 20px; font-weight: 700; }
  footer { position: fixed; bottom: 0; left: 0; right: 0; height: 48px; color:#666; text-align:center; font-size:12px; padding:8px 0; }
  @media print { footer:after { content: "Página " counter(page) " / " counter(pages); } }
  /* Accent for section headers */
  .accent { display:inline-block; padding:4px 8px; background:#ffcc00; color:#000; border-radius:4px; }
  .section { margin-top:20px; }
</style>

<header>
  <img src="logo.png" alt="Invent logo" />
  <div class="title">Projeto BRF — Testes E2E (Cypress)</div>
</header>

<footer>
  Invent — smart intralogistics solutions · Relatório de testes automatizados
</footer>
...
- [Fixtures & Data Generation](#fixtures)
- [CI (GitHub Actions)](#ci)
- [Troubleshooting](#troubleshooting)
- [Next steps recomendados](#next-steps)
- [Testes — descrição por suíte e spec](#testes-descricao)
- [Stakeholder Brief — Resumo Executivo](#stakeholder-brief)
